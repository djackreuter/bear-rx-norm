...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Bear Rx Norm web application."
  #
  #
  ...
  #
  # settings.secret_key_base= W0mm3XEwdkw4uXFglwgQdiycJ8HQ6q794AhYZkN1OY4
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("bear-rx-norm.log", "w"))
  #
  #
end
